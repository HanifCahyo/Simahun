<?php
 ...
 class Penarikan extends CI_Controller
 {
    ...
    {
        $data["penarikan"] = $this->penarikan_model->getTable4();
        $data["penarikan3"] = $this->penarikan_model->getTable();
        $data["penarikan2"] = $this->penarikan_model->getTable1();
        $data['current_user'] = $this->auth_model->current_user();
		$this->load->view("admin/penarikan/list", $data);
    }
    ...
    public function add()
    {
		...
		$data['current_user'] = $this->auth_model->current_user();
		$this->load->view("admin/penarikan/add", $data);
    }
	...
	public function print($id = null)
	{
		...
		$html = $this->load->view('admin/penarikan/cetak', $this->data, true);	    
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('admin/penarikan');
