...
class Sertifikat extends CI_Controller
{
    ...
    {
        $data["sertifikat"] = $this->sertifikat_model->getTable();
        $data["sertifikat2"] = $this->sertifikat_model->getTable1();
        $data['current_user'] = $this->auth_model->current_user();
		$this->load->view("jurusan/guru/sertifikat/list", $data);
    }
    ...
    public function add()
    {
		...
		if ($validation->run()) {
			...
			redirect(site_url('jurusan/guru/sertifikat'));
        }

        $data['program_studi']=$this->auth_model->prodi_enums('user','program_studi');
		$data['current_user'] = $this->auth_model->current_user();
		$this->load->view("jurusan/guru/sertifikat/add", $data);
    }
    ...
    public function print($id = null)
	{
		...
		$html = $this->load->view('jurusan/guru/sertifikat/cetak', $this->data, true);	    
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('jurusan/guru/sertifikat');
        ...
        $data['program_studi']=$this->auth_model->prodi_enums('user','program_studi');
        $this->load->view("jurusan/guru/sertifikat/edit", $data);
    }
