<?php
 ...
 class Penarikan extends CI_Controller
 {
    ...
    public function index() 
    {
        ...
        $data["penarikan2"] = $this->penarikan_model->getTable1();
        $data['current_user'] = $this->auth_model->current_user();
		$this->load->view("jurusan/guru/penarikan/list", $data);
    }
    ...
    public function add()
    {
		...
		if ($validation->run()) {
			...
			redirect(site_url('jurusan/guru/penarikan'));
        }

		$data['current_user'] = $this->auth_model->current_user();
		$this->load->view("jurusan/guru/penarikan/add", $data);
    }
	...
	public function print($id = null)
	{
		...
		$html = $this->load->view('jurusan/guru/penarikan/cetak', $this->data, true);	    
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('jurusan/guru/penarikan');
        ...
        $this->load->view("jurusan/guru/penarikan/edit", $data);
    }
