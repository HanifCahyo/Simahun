...
class Pengajuan extends CI_Controller
{
	...
	{
		$data["pengajuan"] = $this->pengajuan_model->getTable();
	...
	public function add()
    {
		...
		if ($validation->run()) {
			...
			redirect(site_url('jurusan/guru/pengajuan'));
        }
	...
	public function print($id = null)
	{
		...
		$html = $this->load->view('jurusan/guru/pengajuan/cetak', $this->data, true);	    
    ...
    public function edit($id = null)
    {
        ...
        if (!isset($id)) redirect('jurusan/guru/pengajuan');
        ...
        $this->load->view("jurusan/guru/pengajuan/edit", $data);
    }
