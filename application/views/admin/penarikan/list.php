				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="<?php echo site_url('admin/penarikan/add') ?>" role="button">
									Tambahkan Baru
								</a>
							</div>
						</div>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td><span class="badge badge-secondary"<?php echo $aaa->status ?>>Data Dihapus</td>
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<!-- <a class="dropdown-item" href="<?php echo site_url('admin/penarikan/print/' . $aaa->id) ?>"><i class="dw dw-print"></i> Print</a> -->
													<!-- <a class="dropdown-item" href="<?php echo site_url('admin/penarikan/edit/' . $aaa->id) ?>"><i class="dw dw-edit2"></i> Edit</a> -->
													<!-- <a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('admin/penarikan/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Delete</a> -->
												</div>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<!-- <a class="dropdown-item" href="<?php echo site_url('admin/penarikan/print/' . $aaa->id) ?>"><i class="dw dw-print"></i> Print</a> -->
													<a class="dropdown-item" href="<?php echo site_url('admin/penarikan/edit/' . $aaa->id) ?>"><i class="dw dw-edit2"></i> Edit</a>
													<a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('admin/penarikan/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Hapus</a>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="<?php echo site_url('admin/penarikan/print/' . $aaa->id) ?> target="_blank""><i class="dw dw-print" ></i> Print</a>
													<a class="dropdown-item" href="<?php echo site_url('admin/penarikan/edit/' . $aaa->id) ?>"><i class="dw dw-edit2"></i> Edit</a>
													<a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('admin/penarikan/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Hapus</a>
												</div>
											</div>
