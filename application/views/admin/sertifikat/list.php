				...
				<div class="page-header">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12 text-right">
							<div class="dropdown">
								<a class="btn btn-primary" href="<?php echo site_url('admin/sertifikat/add') ?>" role="button">
									Tambahkan Baru
								</a>
							</div>
						</div>
									...
									<tr>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="<?php echo site_url('admin/sertifikat/print/' . $aaa->id) ?>" target="_blank"><i class="dw dw-print" ></i> Print</a>
													<a class="dropdown-item" href="<?php echo site_url('admin/sertifikat/edit/' . $aaa->id) ?>"><i class="dw dw-edit2"></i> Edit</a>
													<a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('admin/sertifikat/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Hapus</a>
												</div>
											</div>
