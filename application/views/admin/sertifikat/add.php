		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="<?php echo site_url('admin/pengajuan/') ?>">Cetak Sertifikat PKL</a></li>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="<?php echo site_url('admin/sertifikat/add') ?>" method="post">
						...
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">admin</label>
							<div class="col-sm-12 col-md-10">
