                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="title">
                                <h4>Data Pengguna Guru</h4>
                            </div>
                            <nav aria-label="breadcrumb" role="navigation">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo site_url('admin/Dashboard/') ?>">Menu Utama</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Data Pengguna Guru</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="col-md-6 col-sm-12 text-right">
                            <!-- <div class="dropdown">
                                <a class="btn btn-primary" href="<?php echo site_url('admin/guru/add') ?>" role="button">
                                    Tambahkan Baru
                                </a>
                            </div> -->
                        </div>
