										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													...
													<a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('jurusan/guru/pengajuan/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Hapus</a>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
													<a class="dropdown-item" href="<?php echo site_url('jurusan/guru/pengajuan/print/' . $aaa->id) ?>" target="_blank"><i class="dw dw-print"></i> Print</a>
													<a class="dropdown-item" href="<?php echo site_url('jurusan/guru/pengajuan/edit/' . $aaa->id) ?>"><i class="dw dw-edit2"></i> Edit</a>
													<a class="dropdown-item" onclick="deleteConfirm('<?php echo site_url('jurusan/guru/pengajuan/delete/' . $aaa->id) ?>')" href="#!"><i class="dw dw-delete-3"></i> Hapus</a>
												</div>
											</div>
