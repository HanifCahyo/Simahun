		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="<?php echo site_url('jurusan/guru/pengajuan/') ?>">Cetak Sertifikat PKL</a></li>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="<?php echo site_url('jurusan/guru/sertifikat/add') ?>" method="post">
