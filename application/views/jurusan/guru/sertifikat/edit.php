						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="<?php echo site_url('jurusan/guru/sertifikat/') ?>">Cetak Sertifikat PKL</a></li>
				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="" method="post">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="number" name="nis" value="<?php echo $sertifikat->nis ?>">
							</div>
						</div>
						<div class="clearfix">
						<div class="pull-left">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<select class="custom-select col-12" name="status">
									<option selected=""><?php echo $sertifikat->status ?></option>
