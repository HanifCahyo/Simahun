				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="<?php echo site_url('jurusan/siswa/kegiatan/add') ?>" method="post" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-12 col-md-10">
								<input class="form-control time-picker" placeholder="Select time" type="text" name="waktu_mulai">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">WAKTU SELESAI</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control time-picker" placeholder="Select time" type="text" name="waktu_selesai">
							</div>
						</div>
						<div class="form-group row">
