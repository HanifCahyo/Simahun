		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					...
					<form action="<?php echo site_url('jurusan/siswa/bimbingan/simpanData') ?>" method="post">

						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Select</label>
							<div class="col-sm-12 col-md-10">
								<select class="custom-select col-12" name="niy">
									<?php foreach ($guru as $guru) : ?>
										<option value="<?php echo $guru->nomor_induk ?>"><?php echo $guru->name ?></option>
									<?php endforeach; ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-sm-12 col-md-10">
								<input class="btn btn-success" type="submit" value="INPUT GURU PEMBIMBING" />
							</div>
						</div>
					</form>
				</div>
